  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">CleanDOM - AI-Powered DOM Pruning for Web Agents</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Provides an API that takes any URL, prunes irrelevant DOM elements (ads, scripts, hidden content) using AI, and returns a simplified, semantic HTML or structured data, making web scraping and agent navigation highly efficient and reliable.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust CleanDOM - AI-Powered DOM Pruning for Web Agents.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} CleanDOM - AI-Powered DOM Pruning for Web Agents. All rights reserved.</p>
