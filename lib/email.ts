...
const FROM = process.env.EMAIL_FROM || 'CleanDOM - AI-Powered DOM Pruning for Web Agents <noreply@example.com>';
const APP_NAME = 'CleanDOM - AI-Powered DOM Pruning for Web Agents';
